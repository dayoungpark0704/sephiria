document.addEventListener('DOMContentLoaded', async () => {
    ...
    // --- 상태 관리 변수 ---
    let inventoryState = []; // 인벤토리에 배치된 아이템 정보 배열
    let ownedItems = {};     // 유저가 보유한 아이템 개수
    ...
    document.getElementById('optimize-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            updateSlots(flatBoard.length); // 슬롯 크기를 결과에 맞게 조정
            inventoryState = flatBoard; // 상태 업데이트
