...
function autoArrange() {
  ...
  allItemsToPlace.sort((a, b) => {
    ...
    if (a.id.startsWith('aritifact_') && !b.id.startsWith('aritifact_')) return -1;
    if (!a.id.startsWith('aritifact_') && b.id.startsWith('aritifact_')) return 1;
    ...
    if (availableSlotsForA !== availableSlotsForB) return availableSlotsForA - availableSlotsForB;
